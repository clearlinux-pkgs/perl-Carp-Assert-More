...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PETDANCE/Carp-Assert-More-1.18.tar.gz
...
%prep
%setup -q -n Carp-Assert-More-1.18
cd ..
%setup -q -T -D -n Carp-Assert-More-1.18 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Carp-Assert-More-1.18/deblicense/
