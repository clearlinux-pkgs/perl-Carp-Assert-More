...
Source0  : https://cpan.metacpan.org/authors/id/P/PE/PETDANCE/Carp-Assert-More-2.3.0.tar.gz
...
%prep
%setup -q -n Carp-Assert-More-2.3.0
cd %{_builddir}
tar xf %{_sourcedir}/libcarp-assert-more-perl_1.16-1.debian.tar.xz
cd %{_builddir}/Carp-Assert-More-2.3.0
mkdir -p deblicense/
cp -r %{_builddir}/debian/* %{_builddir}/Carp-Assert-More-2.3.0/deblicense/
